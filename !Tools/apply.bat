...
REM call :apply_patch skip_intros\diablo.exe.vcdiff
REM call :apply_patch cheat\diablo.exe.vcdiff
REM call :apply_patch music-nompq-fix\diablo.exe.vcdiff
...
call :apply_patch mega_fix\diablo.exe.vcdiff
pause
exit /b
...
:apply_patch
vcdiff.exe decode --dictionary DIABLO.EXE --delta %1 --target DIABLO.EXE
exit /b
