...
DESCRIBE_PATCH("Prevents crashing in situations where the player has more life than max (e.g. from Blood Boil), or less life than 0 (as is typical with Mana Shield).")
